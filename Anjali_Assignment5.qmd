...
```{r}
print(result <- (var_even && !var_pos) || (!var_even && var_pos))
```
...
```{r}
var_seconds <- 185
var_minutes <- as.integer(as.numeric(var_seconds) / 60)
var_leftover <- as.numeric(var_seconds) - var_minutes * 60

if (var_minutes > 1 && var_leftover > 1) {
  print(sprintf("%s seconds is %s minutes and %s seconds", var_seconds, var_minutes, var_leftover))
} else if (var_minutes > 1 && var_leftover == 1) {
  print(sprintf("%s seconds is %s minutes and %s second", var_seconds, var_minutes, var_leftover))
} else if (var_minutes > 1 && var_leftover == 0) {
  print(sprintf("%s seconds is %s minutes and %s seconds", var_seconds, var_minutes, var_leftover))
} else if (var_minutes == 1 && var_leftover == 0) {
  print(sprintf("%s seconds is %s minute and %s seconds", var_seconds, var_minutes, var_leftover))
} else if (var_minutes == 1 && var_leftover == 1) {
  print(sprintf("%s seconds is %s minute and %s second", var_seconds, var_minutes, var_leftover))
} else if (var_minutes == 1 && var_leftover > 1) {
  print(sprintf("%s seconds is %s minute and %s seconds", var_seconds, var_minutes, var_leftover))
} else {
  print(sprintf("%s seconds is %s minutes and %s seconds", var_seconds, var_minutes, var_leftover))
...
```{r}
if (as.numeric(num1) > as.numeric(num2) && as.numeric(num1) > as.numeric(num3)) {
  print(sprintf("%s is the largest number", num1))
} else if (as.numeric(num2) > as.numeric(num1) && as.numeric(num2) > as.numeric(num3)) {
  print(sprintf("%s is the largest number", num2))
} else {
  print(sprintf("%s is the largest number", num3))
}
```
...
if (num1 > num2) {
  if (num1 > num3) {
    print(sprintf("%.0f is the largest number", num1))
  } else {
    print(sprintf("%.0f is the largest number", num3))
  }
} else {
  if (num2 > num3) {
    print(sprintf("%.0f is the largest number", num2))
  } else {
    print(sprintf("%.0f is the largest number", num3))
  }
}
...
if (is_prime) {
  print(sprintf("%s is a prime number", var_89))
} else {
  print(sprintf("%s is not a prime number", var_89))
}
```
...
```{r}
var_4000 <- as.numeric(4000)
i <- 1
while (i^2 <= var_4000) {
  i <- i + 1
}

cat(sprintf("%d squared is %d, and is the first number whose square exceeds %d.\n", i, i^2, var_4000))
